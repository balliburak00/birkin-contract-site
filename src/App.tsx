...
const content = {
  ...
  ar: {
    ...
    materials: [
      ...
      ["ضمان الجودة", "يتم إجراء مراقبة جودة داخلية حسب المشروع، ويمكن تنظيم فحص طرف ثالث قبل الشحن عند الطلب."],
      ["خيارات التخصيص", "يمكن تخصيص المقاسات وألوان الإطارات وخيارات الأقمشة وتشطيبات الخشب وتفاصيل الراحة حسب متطلبات المشروع."],
      ["تغليف مناسب للتصدير", "يمكن تغليف المنتجات بمواد حماية مناسبة للتصدير حسب نوع المنتج ووجهة التسليم وطريقة الشحن."],
      ["عينة ونموذج أولي", "في بعض المشاريع، يمكن تنظيم إنتاج عينة أو مراجعة نموذج أولي قبل الإنتاج الكمي."],
    ],
  ...
  ru: {
    ...
    materials: [
      ...
      ["Контроль качества", "Проводится внутренний контроль качества по проекту. По запросу может быть организована независимая инспекция перед отгрузкой."],
      ["Варианты кастомизации", "Размеры, цвета каркаса, варианты тканей, отделка дерева и детали комфорта могут быть адаптированы под требования проекта."],
      ["Экспортная упаковка", "Продукты могут быть упакованы с защитными материалами для экспорта в зависимости от типа продукта, страны доставки и способа перевозки."],
      ["Образец и прототип", "Для отдельных проектов может быть организовано производство образца или проверка прототипа перед массовым производством."],
    ],
